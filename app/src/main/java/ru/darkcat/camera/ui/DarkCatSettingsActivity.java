...
public final class DarkCatSettingsActivity extends Activity {
    ...
    private void save() {
        ...
        DarkCatSettings.set(this, "darkcat_nextcloud_share", share.getText().toString().trim()); DarkCatSettings.set(this, "darkcat_webdav_base", base.getText().toString().trim()); DarkCatSettings.set(this, "darkcat_remote_folder", folder.getText().toString().trim());
