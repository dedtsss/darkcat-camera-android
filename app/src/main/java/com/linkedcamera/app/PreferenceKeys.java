...
public class PreferenceKeys {
    ...
    // Nextcloud auto-upload preferences
    public static final String NextcloudUploadPreferenceKey = "preference_nextcloud_upload";
    public static final String NextcloudUrlPreferenceKey = "preference_nextcloud_url";
    public static final String NextcloudPasswordPreferenceKey = "preference_nextcloud_password";
    public static final String NextcloudWifiOnlyPreferenceKey = "preference_nextcloud_wifi_only";
    public static final String NextcloudAutoDeletePreferenceKey = "preference_nextcloud_auto_delete";
    public static final String NextcloudProcessQueuePreferenceKey = "preference_nextcloud_process_queue";
}
